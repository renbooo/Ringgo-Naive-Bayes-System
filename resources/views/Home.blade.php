                      ...
                      <div class="panel panel-grey">
                          ...
                          <div class="panel-body">
                              <table class="table table-hover table-bordered">
                                 ...
                                 <tr>
                                     <td>{{$all->ID}}</td>
                                     <td>{{$all->NAMA_KORBAN}}</td>
                                     <td>{{$all->ALAMAT_KORBAN}}</td>
                                     <td>{{$all->JENIS_KELAMIN}}</td>
                                     <td>{{$all->PEKERJAAN}}</td>
                                     <td>{{$all->RENTANG_USIA}}</td>
                                     <td>{{$all->LOKASI_KEJADIAN}}</td>
                                     <td>{{$all->KEADAAN_LOKASI}}</td>
                                     <td>{{$all->WAKTU_KEJADIAN}}</td>
                                     <td>{{$all->KENDARAAN}}</td>
                                     <td>{{$all->KEADAAN_KORBAN}}</td>
                                     <td>{{$all->STATUS_TERSANGKA}}</td>
                                     <td>{{$all->JARAK_KANTOR_POLISI_KE_TKP}}</td>
                                     <td>{{$all->KERUGIAN_MATERIAL}}</td>
                                     <td>{{$all->PATROLI_RUTIN}}</td>
                                 </tr>
                                   @endforeach
                              </table>
                          </div>
