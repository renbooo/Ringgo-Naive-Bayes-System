...
<html>
  ...
  <body>
    <h1>Keadaan Lokasi Ramai ya: {{$ramai->ya->count()}}</h1>
    <table border = 1>
         <tr>
           <th>ID</td>
           <th>NAMA_KORBAN</td>
      ...
      <br><br>
      <h1>Keadaan Lokasi Ramai Tidak {{$ramai->tidak->count()}}</h1>
      <table border="1">
      <tr>
        <th>ID</td>
        <th>NAMA_KORBAN</td>
   ...
   <br><br>
   <h1>Keadaan Lokasi Sepi ya: {{$sepi->ya->count()}}</h1>
   <table border = 1>
        <tr>
          <th>ID</td>
          <th>NAMA_KORBAN</td>
     ...
     <br><br>
     <h1>Keadaan Lokasi Sepi tidak: {{$sepi->tidak->count()}}</h1>
     <table border="1">
     <tr>
       <th>ID</td>
       <th>NAMA_KORBAN</td>
  ...
  <br><br>
  <h1>Keadaan Lokasi Sedang ya: {{$sedang->ya->count()}}</h1>
  <table border = 1>
       <tr>
         <th>ID</td>
         <th>NAMA_KORBAN</td>
    ...
    <br><br>
    <h1>Keadaan Lokasi Sedang tidak: {{$sedang->tidak->count()}}</h1>
    <table border="1">
    <tr>
      <th>ID</td>
      <th>NAMA_KORBAN</td>
